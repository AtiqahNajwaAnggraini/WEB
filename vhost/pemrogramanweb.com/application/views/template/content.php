        ...
        <div class="content-area">
            ...
            <div class="content-area-inner">
                ...
                <section id="intro">
                    ...
                    <div class="container-mid">
                        ...
                        <div class="animation-container animation-fade-down" data-animation-delay="0">
                            ...
                            <h1>I’m Atiqah Najwa Anggraini,</h1>
                        ...
                        <div class="animation-container animation-fade-left" data-animation-delay="300">
                            ...
                            <p class="subline">Berasal dari Tembilahan, Riau. Saya lahir pada tanggal 12 Februari 2003.  Sekarang saya mengenyam pendidikan D3 di Politeknik Kampar dan sedang menjalani semester 4 di program studi Teknik Informatika.</p>
                ...
                <section id="about">
                    ...
                    <p class="scroll-animated-from-right">Saya dapat membantu anda dalam mengerjakan projek-projek kuliah sederhana. Ada beberapa bidang yang dapat saya kerjakan, yaitu mikrokontroler, desain grafis, GIS, desain web, desain Ui & UX.</p>
                ...
                <section id="service">
                    ...
                    <h3 class="headline scroll-animated-from-right">My Skill.</h3>
                    ...
                    <ul class="services-list">
                        ...
                        <li class="scroll-animated-from-right"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Mikrocontroller</li>
                        <li class="scroll-animated-from-right"><i class="fa fa-eye" aria-hidden="true"></i>Design Grafis</li>
                        <li class="scroll-animated-from-right"><i class="fa fa-map" aria-hidden="true"></i>Geographic Information System</li>
                    ...
                    <div class="showcase">
                        ...
                        <div class="item scroll-animated-from-right">
                            ...
                            <a href="#" data-featherlight="#item-1-lightbox">
                                ...
                                <div class="background-image" style="background-image: url(<?=$url?>img/work/Peta-polkam.jpg)"></div>
                            ...
                            <div id="item-1-lightbox" class="work-lightbox">
                                ...
                                <img class="img-responsive" src="<?=$url?>img/work/Peta-polkam.jpg" alt="image">
                                
                                <h3>Politeknik Kampar Map.</h3>
                                <p class="subline">Geographic Information System</p>
                        ...
                        <div class="item scroll-animated-from-right">
                            ...
                            <a href="#" data-featherlight="#item-2-lightbox">
                                ...
                                <div class="background-image" style="background-image: url(<?=$url?>img/work/mikrokontroler.jpg)"></div>
                            ...
                            <div id="item-2-lightbox" class="work-lightbox">
                                ...
                                <img class="img-responsive" src="<?=$url?>img/work/mikrokontroler.jpg" alt="image">
                                
                                <h3>Methane Gas Meter</h3>
                                <p class="subline">Microcontroller</p>
                        ...
                        <div class="item scroll-animated-from-right">
                            ...
                            <a href="#" data-featherlight="#item-3-lightbox">
                                ...
                                <div class="background-image" style="background-image: url(<?=$url?>img/work/year-book.png)"></div>
                            ...
                            <div id="item-3-lightbox" class="work-lightbox">
                                ...
                                <img class="img-responsive" src="<?=$url?>img/work/year-book.png" alt="image">
                                
                                <h3>Year Book</h3>
                                <p class="subline">Design Grafis</p>
                        ...
                        <div class="item scroll-animated-from-right">
                            ...
                            <a href="#" data-featherlight="#item-4-lightbox">
                                ...
                                <div class="background-image" style="background-image: url(<?=$url?>img/work/ui-ux.jpg)"></div>
                            ...
                            <div id="item-4-lightbox" class="work-lightbox">
                                ...
                                <img class="img-responsive" src="<?=$url?>img/work/ui-ux.jpg" alt="image">
                ...
                <section id="contact">
                    ...
                    <ul class="contact-list">
                        ...
                        <li class="scroll-animated-from-right"><i class="fa fa-mobile" aria-hidden="true"></i>0823 9040 0998</li>
                        <li class="scroll-animated-from-right"><i class="fa fa-envelope-o" aria-hidden="true"></i>atiqahnajwaanggraini@mail.com</li>
                ...
                <section id="footer">
                    ...
                    <p class="scroll-animated-from-right">© 2022 Atiqah Najwa Anggraini | 202013024 | TIF 2B </p>
