            ...
            <div class="content-area-inner">
                ...
                <section id="about">
                    ...
                    <?php foreach ($dataorganisasi as $key) : ?>
                        <ul>
                            <li><h6><b><?= $key->nama_organisasi;?>  (<?= $key->periode;?>)</b></h6></li>
                            <u><?= $key->jabatan;?></u><br> <?= $key->deskripsi;?>
                        </ul>
                    <?php endforeach; ?>
                ...
                <section id="contact">
                    ...
                    <ul class="contact-list">
                        ...
                        <li class="scroll-animated-from-right"><i class="fa fa-mobile" aria-hidden="true"></i><?=$data->no_hp?></li>
                        <li class="scroll-animated-from-right"><i class="fa fa-envelope-o" aria-hidden="true"></i><?=$data->email?></li>
                ...
                <section id="footer">
                    ...
                    <p class="scroll-animated-from-right">© 2022 <?=$data->nama?> | <?=$data->sandi?> | TIF 2B </p>
